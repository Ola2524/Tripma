...
export const hotels = [
  { id: 1, name: "The Bund", img: "hotel1.jfif", price: 598, description: "China’s most international city", city_id: 1 },
  { id: 2, name: "Sydney Opera House", img: "hotel2.png", price: 981, description: "Take a stroll along the famous harbor", city_id: 2 },
  { id: 3, name: "Kōdaiji Temple", img: "hotel3.png", price: 633, description: "Step back in time in the Gion district", city_id: 3 },
  { id: 4, name: "Tsavo East National Park, Kenya", img: "hotel4.jfif", price: "$1,248", description: "Named after the Tsavo River, and opened in April 1984, Tsavo East National Park is one of the oldest parks in Kenya. It is located in the semi-arid Taru Desert.", city_id: 3 },
];
